...
network_to_command = {
    ...
    "preact_resnet1001": "python3 main.py --dataset cifar10 --arch preact_resnet1001 "
                       ...
                       "--training-only --label-smoothing 0 CONFIG "
                       "--workspace results/tmp --gather-checkpoints  ~/data/cifar10",
    "resnet50":  "python3 dist_train.py --worker_num 1 --worker_index 0 --role worker --endpoints 127.0.0.1:7164 --use_gpu True --model resnet50 --config CONFIG --data ~/imagenet --batch_size BS",
    "resnet152":  "python3 dist_train.py --worker_num 1 --worker_index 0 --role worker --endpoints 127.0.0.1:7164 --use_gpu True --model resnet152 --config CONFIG --data ~/imagenet --batch_size BS",
}
