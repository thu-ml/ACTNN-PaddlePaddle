...
from paddle.nn import Conv2D, Linear, BatchNorm2D, ReLU, MaxPool2D, SyncBatchNorm
...
class ResNetBuilder(object):
    ...
    def batchnorm(self, planes, last_bn=False):
        ...
        nn.initializer.Constant(bn.weight, gamma_init_val)
        nn.initializer.Constant(bn.bias, 0)
        return bn
...
resnet_configs = {
        'classic' : {
            ...
            'activation' : lambda: ReLU(inplace=True),
